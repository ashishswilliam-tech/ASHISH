...
map.getView().fit([8572568.483454, 933410.054055, 8592274.880167, 947907.690458], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NEYYATTINKARA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (576 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Neyyattinkara is a municipal town in Thiruvananthapuram district, Kerala, India. It also serves as the administrative headquarters of Neyyattinkara taluk. Nestled along the banks of the Neyyar River, one of the district\'s principal rivers, the town derives its name from its location, with \'Neyyatinkara\' in Malayalam translating to \'the shore of the river Neyyar.\' Neyyattinkara ranks as the second most densely populated municipality in the district, following Varkala. Notably, the Vizhinjam International Seaport Thiruvananthapuram is situated within Neyyattinkara Taluk."';
            }
